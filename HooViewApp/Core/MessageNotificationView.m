...
- (CGFloat)updateHeightOfMessageView {
    CGFloat screenWidth = self.viewController.view.bounds.size.width;
//    self.contentLabel.frame = CGRectMake(self.textSpaceLeft,    //X
//                                         MessageLabelPadding,   //Y
//                                         screenWidth - self.textSpaceLeft, //Width
//                                         0.0  // Height
//                                         );
//    [self.contentLabel sizeToFit];
    
    CGFloat currentHeight = self.contentLabel.frame.origin.y + self.contentLabel.frame.size.height + MessageLabelPadding;
//    if ( (self.iconImageView.frame.origin.y + self.iconImageView.frame.size.height + MessageViewPadding) > currentHeight) {
